    ...
    <v-dialog v-model=" internalShow " max-width="500px">
        <v-card class="rounded-xl pt-6 pb-4">
            ...
            <v-card-actions class="justify-end pt-2 pr-6">
                <v-btn color="error" variant="outlined" @click=" close " class="text-capitalize px-8" rounded="pill">
                    Batalkan
                </v-btn>
                <v-btn color="error" variant="flat" @click=" confirm " class="text-capitalize px-8" rounded="pill">
                    Hapus
                </v-btn>
            </v-card-actions>
        </v-card>
